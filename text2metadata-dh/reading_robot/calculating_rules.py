...
def use_calculating_rules(wdir, sep, freq_table, class_, default_feature_class_labels, non_default_features_class_labels, verbose = False, default_features_threshold = "None"):
    corpus = load_data.load_corpus(wdir = wdir, freq_table = freq_table, verbose = verbose, min_MFF = 0, max_MFF = 5000)
    ...
    score = rule_tokens(document_data_raw = document_data_raw, df_labels = labels, default_feature_class_labels = default_feature_class_labels, non_default_features_class_labels = non_default_features_class_labels, class_ = class_, default_features_threshold = default_features_threshold, wdir = wdir, corpus = corpus)
    print("Baseline: ", baseline)
    return score

#score = use_calculating_rules(wdir = "/home/jose/Dropbox/MTB/investigacion/mytoolbox/reading_robot/data/" , sep = ",", freq_table = "freq_table_raw.csv", default_feature_class_labels = {"pueblos": "rural"}, non_default_features_class_labels = {"capital": "big-city", "provincia": "small-city", "barco":"boat"}, class_ = "setting", default_features_threshold = 0.4 )
#score = use_calculating_rules( wdir = "/home/jose/Dropbox/MTB/investigacion/mytoolbox/reading_robot/data/" , sep = ",", freq_table = "freq_table_raw.csv", default_feature_class_labels = {"dijo": "third-person"}, non_default_features_class_labels = {"dije": "first-person", "dijiste": "second-person"}, class_ = "narrator", default_features_threshold = 0.9)
#score = use_calculating_rules( wdir = "/home/jose/Dropbox/MTB/investigacion/mytoolbox/reading_robot/data/" , sep = ",", freq_table = "freq_table_raw.csv", default_feature_class_labels = {"él": "male"}, non_default_features_class_labels = {"ella": "female"}, class_ = "protagonist-gender")

#non_default_features_class_labels = {"bilbao" : "Bilbao","brandeso" : "Brandeso","castellar" : "Castellar","confines" : "Confines","granburgo" : "Granburgo","guadix" : "Guadix","jerez" : "Jerez","joya" : "La Joya","marineda" : "Marineda","parcent" : "Parcent","ulloa" : "Pazos de Ulloa","santander" : "Santander","tablanca" : "Tablanca","valencia" : "Valencia","valverde" : "Valverde de Lucerna","vetusta" : "Vetusta","villaalegre" : "Villaalegre","villaruin" : "Villaruin","Mixed" : "mixed","none" : "n.av.","other_mixed" : "other/mixed","Unknown" : "unknown", "Unknown2" : "?"}
#score = use_calculating_rules( wdir = "/home/jose/Dropbox/MTB/investigacion/mytoolbox/reading_robot/data/" , sep = ",", freq_table = "freq_table_raw.csv", default_feature_class_labels = {"madrid": "Madrid"}, non_default_features_class_labels = non_default_features_class_labels, class_ = "setting-name")
