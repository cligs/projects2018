...
def plot_confusion_matrix(labels_eval, labels_pred, class_values, class_, wdir,
    ...
    plt.yticks(tick_marks, class_values, rotation=45)
    ...
    plt.savefig(wdir+"visualisations/"+name_vis+".svg",bbox_inches='tight')
    plt.savefig(wdir+"visualisations/"+name_vis+".jpg",bbox_inches='tight')
    plt.show()
